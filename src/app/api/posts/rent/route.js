...
async function getPostCounts() {
    ...
    const apartments = await Post.countDocuments({housing: apartment._id, posttype: 'rent'});
    const houses = await Post.countDocuments({housing: house._id, posttype: 'rent'});
    const commercials = await Post.countDocuments({housing: commercial._id, posttype: 'rent'});
