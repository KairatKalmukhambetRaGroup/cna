...
async function GET(request) {
    ...
    try {
        ...
        if (ip) {
            const existingUserVisit = await uservisit/* default */.Z.findOne({
                ip,
                timestamp
            });
            if (!existingUserVisit) {
                await uservisit/* default */.Z.create({
                    ip,
                    timestamp
                });
            }
        }
        return next_response/* default */.Z.json(timestamp);
    } catch (error) {
        console.log(error);
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-app-loader.js?page=%2Fapi%2Froute&name=app%2Fapi%2Froute&pagePath=private-next-app-dir%2Fapi%2Froute.js&appDir=D%3A%5Cpersonal%20projects%5Ckrisha-next%5Csrc%5Capp&appPaths=%2Fapi%2Froute&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&basePath=&assetPrefix=&nextConfigOutput=&preferredRegion=&middlewareConfig=e30%3D!
    ...
    const options = {"definition":{"kind":"APP_ROUTE","page":"/api/route","pathname":"/api","filename":"route","bundlePath":"app/api/route"},"resolvedPagePath":"D:\\personal projects\\krisha-next\\src\\app\\api\\route.js","nextConfigOutput":""}
...
var __webpack_exports__ = __webpack_require__.X(0, [2697,5501,9335], () => (__webpack_exec__(35980)));
