...
// NAMESPACE OBJECT: ./src/app/api/advertisements/[id]/route.js
...
;// CONCATENATED MODULE: ./src/app/api/advertisements/[id]/route.js
...
async function GET(request, context) {
    ...
    try {
        ...
        const ad = await advertisement/* default */.Z.findById(id);
...
async function DELETE(request, context) {
    ...
    try {
        await (0,connect/* default */.Z)();
        await advertisement/* default */.Z.findByIdAndDelete(id);
...
async function PATCH(request, context) {
    ...
    try {
        await (0,connect/* default */.Z)();
        const existingAd = await advertisement/* default */.Z.findById(id);
        ...
        const ad = await advertisement/* default */.Z.findByIdAndUpdate(id, {
            ...data
        }, {
            new: true
        });
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-app-loader.js?page=%2Fapi%2Fadvertisements%2F%5Bid%5D%2Froute&name=app%2Fapi%2Fadvertisements%2F%5Bid%5D%2Froute&pagePath=private-next-app-dir%2Fapi%2Fadvertisements%2F%5Bid%5D%2Froute.js&appDir=D%3A%5Cpersonal%20projects%5Ckrisha-next%5Csrc%5Capp&appPaths=%2Fapi%2Fadvertisements%2F%5Bid%5D%2Froute&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&basePath=&assetPrefix=&nextConfigOutput=&preferredRegion=&middlewareConfig=e30%3D!
    ...
    const options = {"definition":{"kind":"APP_ROUTE","page":"/api/advertisements/[id]/route","pathname":"/api/advertisements/[id]","filename":"route","bundlePath":"app/api/advertisements/[id]/route"},"resolvedPagePath":"D:\\personal projects\\krisha-next\\src\\app\\api\\advertisements\\[id]\\route.js","nextConfigOutput":""}
    ...
    const originalPathname = "/api/advertisements/[id]/route"
...
var __webpack_exports__ = __webpack_require__.X(0, [2697,5501,9335,9402], () => (__webpack_exec__(24913)));
