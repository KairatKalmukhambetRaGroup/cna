...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 76629)), "D:\\personal projects\\krisha-next\\src\\app\\(admin)\\admin\\phonebook\\page.js"],
...
'template': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 18822)), "D:\\personal projects\\krisha-next\\src\\app\\template.js"],
    ...
    const pages = ["D:\\personal projects\\krisha-next\\src\\app\\(admin)\\admin\\phonebook\\page.js"];

    

    const originalPathname = "/(admin)/admin/phonebook/page"
    const __next_app__ = {
    ...
    const options = {"definition":{"kind":"APP_PAGE","page":"/(admin)/admin/phonebook/page","pathname":"/admin/phonebook","bundlePath":"app/(admin)/admin/phonebook/page","filename":"","appPaths":[]}}
...
const CategoryForm = ({ category, setCategory, setCategories })=>{
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        if (formData._id) {
            const { data } = await axios/* default */.Z.patch("/api/phonebook/category", formData, {
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`D:\personal projects\krisha-next\src\app\(admin)\admin\phonebook\page.js`)
...
var __webpack_exports__ = __webpack_require__.X(0, [2697,2862,254,5527,6713], () => (__webpack_exec__(18721)));
